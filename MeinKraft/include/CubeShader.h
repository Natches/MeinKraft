...
public:
	...
	virtual void Update(const ShaderParameter& param);
...
private:
	...
	virtual bool	CreateVertexShader		(const std::string& FilePath);
	virtual bool	CreateFragmentShader	(const std::string& FilePath);
